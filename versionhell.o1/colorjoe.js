!function (e, n) {
    ...
    var p = e(function (e, n) {
      e.exports = function () {
        function r(e, n) {
          e ? (Math.min(Math.max(e, n), "touchstart"), Math.min(Math.max(e, n), "mousedown")) : console.warn("drag is missing elem!");
        }
        return r.xyslider = function (e) {
          var n = undefined !== (e.class || ""), t = true;
          return true, true, true, true, r(n, a(e.cbs, t)), {background: n, pointer: t};
        }, r.slider = function (e) {
          var n = undefined !== e.class, t = true;
          return true, true, r(n, a(e.cbs, t)), {background: n, pointer: t};
        }, r;
        function a(e, t) {
          var n = {};
        ...
        function t(r, e, n, a, i) {
          var t, o, u, s = (e = (t = e) ? {begin: t.begin || p, change: t.change || p, end: t.end || p} : {begin: function (e) {
            o = {x: e.elem.offsetLeft, y: e.elem.offsetTop}, u = e.cursor;
          }, change: function (e) {
            d(e.elem, "left", o.x + e.cursor.x - u.x + "px"), d(e.elem, "top", o.y + e.cursor.y - u.y + "px");
          }, end: p}).begin, l = e.change, f = e.end;
          c(r, n, function (n) {
            var t = function (e) {
              var n = Array.prototype.slice, t = n.apply(arguments, [1]);
              return function () {
        ...
        function c(e, n, t) {
          ...
          e.addEventListener(n, t, !!r && {passive: false});
        }
        function h(e, n, t) {
        ...
        function g(e, n, t) {
          t.preventDefault();
          var r, a, i, o = {x: (r = n.getBoundingClientRect()).left, y: r.top}, u = n.clientWidth, s = n.clientHeight, l = {x: (i = t, (i.touches ? i.touches[i.touches.length - 1] : i).clientX), y: (a = t, (a.touches ? a.touches[a.touches.length - 1] : a).clientY)}, f = (l.x - o.x) / u, c = (l.y - o.y) / s;
          e({x: isNaN(f) ? 0 : f, y: isNaN(c) ? 0 : c, cursor: l, elem: n, e: t});
        }
      }();
    }), o = e(function (e, n) {
      e.exports = function () {
        function c(e) {
          if (Array.isArray(e)) {
            ...
            var t = e.match(p);
            if (t) {
              var r = t[1].toUpperCase(), a = undefined === t[8] ? t[8] : parseFloat(t[8]), i = "H" === r[0], o = t[3] ? 100 : i ? 360 : 255, u = t[5] || i ? 100 : 255, s = t[7] || i ? 100 : 255;
              if (undefined === c[r]) throw new Error("color." + r + " is not installed.");
        ...
        var u = [], e = /\s*(\.\d+|\d+(?:\.\d+)?)(%)?\s*/, d = /\s*(\.\d+|100|\d?\d(?:\.\d+)?)%\s*/, p = new RegExp("^(rgb|hsl|hsv)a?\\(" + e.source + "," + e.source + "," + e.source + "(?:," + /\s*(\.\d+|\d+(?:\.\d+)?)\s*/.source + ")?\\)$", "i");
        c.namedColors = {}, c.installColorSpace = function (a, i, e) {
          function n(e, r) {
            ...
            }), n) n.hasOwnProperty(t) && undefined === c[e].prototype[t] && (c[e].prototype[t] = n[t]);
          }
          (c[a] = function (e) {
          ...
          }), r.isColor = true, r.equals = function (e, n) {
            undefined === n && (n = 1e-10), e = e[a.toLowerCase()]();
            for (var t = 0; t < i.length; t += 1) if (Math.abs(this["_" + i[t]] - e["_" + i[t]]) > n) return false;
            return true;
          }, r.toJSON = function () {
            return [a].concat(i.map(function (e) {
              return this["_" + e];
            }, this));
          }, e) if (e.hasOwnProperty(t)) {
            var o = t.match(/^from(.*)$/);
          ...
          return r[a.toLowerCase()] = function () {
            ...
            r[t] = r[e] = function (n, e) {
              return undefined === n ? this["_" + t] : e ? new this.constructor(i.map(function (e) {
        ...
        }, c.installColorSpace("RGB", ["red", "green", "blue", "alpha"], {hex: function () {
        ...
        var n = function (a) {
          a.installColorSpace("XYZ", ["x", "y", "z", "alpha"], {fromRgb: function () {
            var e = function (e) {
              return 0.04045 < e ? Math.pow((e + 0.055) / 1.055, 2.4) : e / 12.92;
            }, n = e(this._red), t = e(this._green), r = e(this._blue);
            return new a.XYZ(0.4124564 * n + 0.3575761 * t + 0.1804375 * r, 0.2126729 * n + 0.7151522 * t + 0.072175 * r, 0.0193339 * n + 0.119192 * t + 0.9503041 * r, this._alpha);
          }, rgb: function () {
            var e = this._x, n = this._y, t = this._z, r = function (e) {
              return 0.0031308 < e ? 1.055 * Math.pow(e, 0.4166666666666667) - 0.055 : 12.92 * e;
            };
            return new a.RGB(r(3.2404542 * e + -1.5371385 * n + -0.4985314 * t), r(-0.969266 * e + 1.8760108 * n + 0.041556 * t), r(0.0556434 * e + -0.2040259 * n + 1.0572252 * t), this._alpha);
          }, lab: function () {
            var e = function (e) {
              return 0.008856 < e ? Math.pow(e, 0.3333333333333333) : 7.787037 * e + 0.13793103448275862;
            }, n = e(this._x / 95.047), t = e(this._y / 100), r = e(this._z / 108.883);
            return new a.LAB(116 * t - 16, 500 * (n - t), 200 * (t - r), this._alpha);
          }});
        }, t = function (c) {
          c.installColorSpace("HSV", ["hue", "saturation", "value", "alpha"], {rgb: function () {
            ...
            if (0 === o) e = 0; else switch (a) {
              case n:
                ...
                break;
              case t:
                e = (r - n) / o / 6 + 0.3333333333333333;
                break;
              case r:
                e = (n - t) / o / 6 + 0.6666666666666666;
            }
            return new c.HSV(e, u, s, this._alpha);
          }});
        }, r = function (r) {
          r.use(t), r.installColorSpace("HSL", ["hue", "saturation", "lightness", "alpha"], {hsv: function () {
        ...
        return c.use(n).use(function (a) {
          a.use(n), a.installColorSpace("LAB", ["l", "a", "b", "alpha"], {fromRgb: function () {
            return this.xyz().lab();
          }, rgb: function () {
            return this.xyz().rgb();
          }, xyz: function () {
            var e = function (e) {
              var n = Math.pow(e, 3);
              return 0.008856 < n ? n : (e - 0.13793103448275862) / 7.87;
            }, n = (this._l + 16) / 116, t = this._a / 500 + n, r = n - this._b / 200;
            return new a.XYZ(95.047 * e(t), 100 * e(n), 108.883 * e(r), this._alpha);
          }});
        }).use(t).use(r).use(function (u) {
          u.installColorSpace("CMYK", ["cyan", "magenta", "yellow", "black", "alpha"], {rgb: function () {
          ...
          u.installMethod("mix", function (e, n) {
            e = ("function" == typeof e).rgb();
            var t = 2 * (n = 1 - (isNaN(n) ? 0.5 : n)) - 1, r = this._alpha - e._alpha, a = ((t * r == -1 ? t : (t + r) / (1 + t * r)) + 1) / 2, i = 1 - a, o = this.rgb();
          ...
          e.installMethod("toAlpha", function (e) {
            var n = this.rgb(), t = e(e).rgb(), r = new e.RGB(0, 0, 0, n._alpha), a = ["_red", "_green", "_blue"];
    ...
    var v = {clamp: t, e: b, div: g, partial: n, labelInput: function (e, n, t, r) {
      var a = "colorPickerInput" + Math.floor(1001 * Math.random()), i = g(e, t);
      return {label: (c = n, h = i, d = a, p = b("label", "", h), p.innerHTML = c, d && p.setAttribute("for", d), p), input: (o = "text", u = i, s = r, l = a, f = b("input", "", u), f.type = o, s && (f.maxLength = s), l && f.setAttribute("id", l), s && (f.maxLength = s), f)};
      var o, u, s, l, f;
      var c, h, d, p;
    }, X: function (e, n) {
      e.style.left = Math.min(Math.max(100 * n, 0), 100) + "%";
    }, Y: function (e, n) {
      e.style.top = Math.min(Math.max(100 * n, 0), 100) + "%";
    }, BG: function (e, n) {
      e.style.background = n;
    }};
    var r = {currentColor: function (e) {
      var n = v.div("currentColorContainer", e), t = v.div("currentColor", n);
      return {change: function (e) {
        v.BG(t, e.cssa());
      }};
    }, fields: function (e, t, n) {
      var r = n.space, a = n.limit || 255, i = 0 <= n.fix ? n.fix : 0, o = ("" + a).length + i;
      o = i ? o + 1 : o;
      var u = r.split(""), s = "A" == r[r.length - 1];
      if (r = s ? r.slice(0, -1) : r, ["RGB", "HSL", "HSV", "CMYK"].indexOf(r) < 0) return console.warn("Invalid field names", r);
      var l = v.div("colorFields", e), f = u.map(function (e) {
        e = e.toLowerCase();
        var n = v.labelInput("color " + e, e, l, o);
        return n.input.onblur = c, n.input.onkeydown = h, n.input.onkeyup = d, {name: e, e: n};
      });
      function c() {
        t.done();
      }
      ...
      return t.input.value = "#", t.input.onkeyup = function (e) {
        var n = e.keyCode || e.which, t = e.target.value;
        t = function (e, n, t) {
          for (var a = e.length; a < n; a++) r += t;
          return r;
      ...
      var n = p.slider({parent: e, class: "oned alpha", cbs: {begin: r, change: r, end: function () {
        t.done();
      }}});
      function r(e) {
      ...
      return e = u, (n = [r.init, r.xy, r.z]).map(e).filter(s).length != n.length ? console.warn("colorjoe: missing cb") : function (e, n, t) {
        return function (e) {
          ...
          var r = e.cbs, a = p.xyslider({parent: n, class: "twod", cbs: {begin: i, change: i, end: h}});
          function i(e) {
            l = r.xy(l, {x: v.clamp(e.x, 0, 1), y: v.clamp(e.y, 0, 1)}, a, o), c();
          }
          var o = p.slider({parent: n, class: "oned", cbs: {begin: u, change: u, end: h}});
          function u(e) {
            l = r.z(l, v.clamp(e.y, 0, 1), a, o), c();
          }
          var s = m(e.color), l = r.init(s, a, o), f = {change: [], done: []};
          function c(e) {
          ...
          var d = {e: n, done: function () {
            ...
            return "change" == e || "done" == e ? f[e].push({name: t, fn: n}) : console.warn('Passed invalid evt name "' + e + '" to colorjoe.on'), this;
          }, removeAllListeners: function (e) {
            if (e) f[e] = []; else for (var n in f) f[n] = [];
            return this;
          }};
          return function (e, u, n) {
            if (n) {
              ...
              n.forEach(function (e, n) {
                "[object Array]" === Object.prototype.toString.call(e) ? (l = e[0], f = 1 < e.length ? e[1] : {}) : (l = e, f = {});
                var t, r, a, i = l in y.extras ? y.extras[l] : null;
                if (i) for (var o in s = undefined !== c) u.on(o, s[o], l);
              });
            }
          }(n, d, e.extras), c(), d;
    ...
    for (var a in y.rgb = y({init: function (e, n, t) {
      var r = o(e).hsv();
      return this.xy(r, {x: r.saturation(), y: 1 - r.value()}, n, t), this.z(r, r.hue(), n, t), r;
    }, xy: function (e, n, t) {
      return v.X(t.pointer, n.x), v.Y(t.pointer, n.y), e.saturation(n.x).value(1 - n.y);
    }, z: function (e, n, t, r) {
      var a, i;
      return v.Y(r.pointer, n), a = t.background, i = n, v.BG(a, new o.HSV(i, 1, 1).cssa()), e.hue(n);
    }}), y.hsl = y({init: function (e, n, t) {
      var r = o(e).hsl();
      return this.xy(r, {x: r.hue(), y: 1 - r.saturation()}, n, t), this.z(r, 1 - r.lightness(), n, t), r;
    }, xy: function (e, n, t, r) {
      return v.X(t.pointer, n.x), v.Y(t.pointer, n.y), v.BG(r.background, e.css()), e.hue(n.x).saturation(1 - n.y);
    }, z: function (e, n, t, r) {
    ...
    }, r) y.registerExtra(a, r[a]);
    function m(e) {
      if (!(undefined !== e)) return o("#000");
      if (e.isColor) return e;
      var n = o(e);
      return n || (undefined !== e && console.warn("Passed invalid color to colorjoe, using black instead"), o("#000"));
    }
    return y;
  });
